...
╠ [🌷]  ɴᴀᴍᴇﾒ  ◂⚚▸ {user.mention} 
╠ [🧿]  ᴜsᴇʀ ɪᴅﾒ ◂⚚▸ {user.id} 
╠ [🍃] ᴜsᴇʀɴᴀᴍᴇﾒ : - ◂⚚▸ @{user.username} 
╚══════════════════
❍══════════════════════════❍         
    ʀᴜʟᴇs:- ✅
-----------------------------------------------------
 ⫸ ɴᴏ ᴏɴᴇ ᴡɪʟʟ ꜱᴘᴇᴀᴋ ᴀʙᴏᴜᴛ ʜɪɴᴅᴜ, ᴍᴜꜱʟɪᴍ ᴏʀ ᴀɴʏ ᴏᴛʜᴇʀ ʀᴇʟɪɢɪᴏɴ.   
⫸ ɴᴏ ᴏɴᴇ ᴡɪʟʟ ᴘʀᴏᴍᴏᴛᴇ ᴛʜᴇɪʀ ᴏᴡɴ ɢʀᴏᴜᴘ 
⫸ ᴅᴍ= ʙᴀɴ   
⫸ ʙᴇ ᴘᴏʟɪᴛᴇ ᴡɪᴛʜ ᴏᴛʜᴇʀꜱ  
⫸ ᴅᴏɴ'ᴛ ᴀʙᴜꜱɪᴠᴇ ᴡᴏʀᴅꜱ ᴛᴏ ʜᴜᴍɪʟᴀᴛᴇ ᴀɴʏʙᴏᴅʏ ɪɴ ᴛʜɪꜱ ɢʀᴏᴜᴘ  
⫸ᴏɴʟʏ ᴇɴɢʟɪꜱʜ ᴀɴᴅ ʜɪɴᴅɪ ʟᴀɴɢᴜᴀɢᴇ ɪꜱ ᴀʟʟᴏᴡᴇᴅ  
     ࿃─────────────࿃*
""",
